...
function displayMessage(msg) {
    ...
    const date = new Date(msg.id); // Assuming msg.id is a timestamp
...
function updateUserList(users) {
    ...
    users.forEach(user => {
        ...
        li.textContent = user;
        // For simplicity, all users are shown as online. 
        // In a real app, you'd track online status on the server.
